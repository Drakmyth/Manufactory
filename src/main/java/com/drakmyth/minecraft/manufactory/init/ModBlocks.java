...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> AMBER_BLOCK = registerBlock("amber_block", () -> new Block(defaultDecorProperties(MaterialColor.COLOR_YELLOW)));
    public static final RegistryObject<Block> GRINDER = registerBlock("grinder", () -> new GrinderBlock(defaultMachineProperties()));
    public static final RegistryObject<Block> BALL_MILL = registerBlock("ball_mill", () -> new BallMillBlock(defaultMachineProperties()));
    public static final RegistryObject<Block> LATEX_COLLECTOR = registerBlock("latex_collector", () -> new LatexCollectorBlock(Block.Properties.of(Material.WOOD).strength(1.0f).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> POWER_CABLE = registerBlock("power_cable", () -> new PowerCableBlock(Block.Properties.of(Material.DECORATION).strength(0.7f).sound(SoundType.METAL)));
    public static final RegistryObject<Block> SOLAR_PANEL = registerBlock("solar_panel", () -> new SolarPanelBlock(defaultMachineProperties()));
    ...
    public static final RegistryObject<LiquidBlock> SLURRIED_COPPER_ORE = BLOCKS.register("slurried_copper_ore", () -> new LiquidBlock(() -> ModFluids.SLURRIED_COPPER_ORE.get(), defaultFluidProperties()));
    ...
    public static final Map<RegistryObject<Block>, Item.Properties> BLOCKITEM_PROPS = Stream.of(
        new SimpleEntry<>(LATEX_COLLECTOR, defaultBlockItemProps().stacksTo(16))
