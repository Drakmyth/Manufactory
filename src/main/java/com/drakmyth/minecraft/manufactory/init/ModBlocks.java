...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> AMBER_BLOCK = BLOCKS.register("amber_block", () -> new Block(defaultDecorProperties(MaterialColor.COLOR_YELLOW)));
    ...
    public static final RegistryObject<Block> LATEX_COLLECTOR = BLOCKS.register("latex_collector", () -> new LatexCollectorBlock(Block.Properties.of(Material.WOOD).strength(1.0f).sound(SoundType.WOOD)));
