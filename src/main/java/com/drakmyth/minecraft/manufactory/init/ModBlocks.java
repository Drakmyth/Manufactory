...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> BALL_MILL = BLOCKS.register("ball_mill", () -> new BallMillBlock(Block.Properties.create(Material.IRON, MaterialColor.BLACK)));
