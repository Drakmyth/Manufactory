...
public final class ModItems {
    ...
    // Motor Tiers
    public static final RegistryObject<Item> MOTOR_TIER0 =
            ITEMS.register("motor_tier0", () -> new MotorUpgradeItem(singleItemProperties(), 1.0f, Tiers.WOOD.getSpeed()));
    public static final RegistryObject<Item> MOTOR_TIER1 =
            ITEMS.register("motor_tier1", () -> new MotorUpgradeItem(singleItemProperties(), 2.0f, Tiers.STONE.getSpeed()));
    public static final RegistryObject<Item> MOTOR_TIER2 =
            ITEMS.register("motor_tier2", () -> new MotorUpgradeItem(singleItemProperties(), 4.0f, Tiers.IRON.getSpeed()));
    public static final RegistryObject<Item> MOTOR_TIER3 =
            ITEMS.register("motor_tier3", () -> new MotorUpgradeItem(singleItemProperties(), 8.0f, Tiers.DIAMOND.getSpeed()));

    // Grinder Wheels
    public static final RegistryObject<Item> GRINDER_WHEEL_TIER0 =
            ITEMS.register("grinder_wheel_tier0", () -> new GrinderWheelUpgradeItem(singleItemProperties(), Tiers.WOOD, 0f));
    public static final RegistryObject<Item> GRINDER_WHEEL_TIER1 =
            ITEMS.register("grinder_wheel_tier1", () -> new GrinderWheelUpgradeItem(singleItemProperties(), Tiers.STONE, 0.25f));
    public static final RegistryObject<Item> GRINDER_WHEEL_TIER2 =
            ITEMS.register("grinder_wheel_tier2", () -> new GrinderWheelUpgradeItem(singleItemProperties(), Tiers.IRON, 0.5f));
    public static final RegistryObject<Item> GRINDER_WHEEL_TIER3 =
            ITEMS.register("grinder_wheel_tier3", () -> new GrinderWheelUpgradeItem(singleItemProperties(), Tiers.DIAMOND, 0.75f));
    public static final RegistryObject<Item> GRINDER_WHEEL_TIER4 =
            ITEMS.register("grinder_wheel_tier4", () -> new GrinderWheelUpgradeItem(singleItemProperties(), Tiers.NETHERITE, 1f));

    // Milling Balls
    public static final RegistryObject<Item> MILLING_BALL_TIER0 =
            ITEMS.register("milling_ball_tier0", () -> new MillingBallTier0UpgradeItem(smallStackItemProperties()));
    public static final RegistryObject<Item> MILLING_BALL_TIER1 =
            ITEMS.register("milling_ball_tier1", () -> new MillingBallUpgradeItem(smallStackItemProperties(), Tiers.STONE, 0.25f));
    public static final RegistryObject<Item> MILLING_BALL_TIER2 =
            ITEMS.register("milling_ball_tier2", () -> new MillingBallUpgradeItem(smallStackItemProperties(), Tiers.IRON, 0.5f));
    public static final RegistryObject<Item> MILLING_BALL_TIER3 =
            ITEMS.register("milling_ball_tier3", () -> new MillingBallUpgradeItem(smallStackItemProperties(), Tiers.DIAMOND, 0.75f));
    public static final RegistryObject<Item> MILLING_BALL_TIER4 =
            ITEMS.register("milling_ball_tier4", () -> new MillingBallUpgradeItem(smallStackItemProperties(), Tiers.NETHERITE, 1f));
    ...
    public static final RegistryObject<Item> SLURRIED_REDSTONE_ORE_BUCKET =
            ITEMS.register("slurried_redstone_ore_bucket", () -> new BucketItem(() -> ModFluids.SLURRIED_REDSTONE_ORE.get(), singleItemProperties()));
    public static final RegistryObject<Item> SLURRIED_ANCIENT_DEBRIS_BUCKET =
