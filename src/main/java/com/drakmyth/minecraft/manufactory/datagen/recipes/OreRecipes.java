...
public final class OreRecipes extends RecipeProvider {
    ...
    public static void build(Consumer<FinishedRecipe> consumer) {
        ...
        List<OreProcessingRecipeData> ores = Arrays.asList(
                ...
                new OreProcessingRecipeData(Items.NETHER_QUARTZ_ORE, ModItems.GROUND_NETHER_QUARTZ_ORE_ROUGH, ModItems.GROUND_NETHER_QUARTZ_ORE_FINE,
                        ModFluids.SLURRIED_NETHER_QUARTZ_ORE, Items.QUARTZ, Tiers.WOOD),
                ...
                new OreProcessingRecipeData(Items.ANCIENT_DEBRIS, ModItems.GROUND_ANCIENT_DEBRIS_ROUGH, ModItems.GROUND_ANCIENT_DEBRIS_FINE, ModFluids.SLURRIED_ANCIENT_DEBRIS,
                        Items.NETHERITE_SCRAP, Tiers.DIAMOND));
    ...
    private static class OreProcessingRecipeData {
        ...
        public OreProcessingRecipeData(TagKey<Item> oreTag, RegistryObject<Item> stage1, RegistryObject<Item> stage2, RegistryObject<FlowingFluid> stage3,
                /* Item stage4, */ Item stage5, Tier tier, int[] extraAmounts) {
            this(null, oreTag, stage1.get(), stage2.get(), stage3.get(), /* stage4, */ stage5, tier, extraAmounts);
        }

        public OreProcessingRecipeData(TagKey<Item> oreTag, RegistryObject<Item> stage1, RegistryObject<Item> stage2, RegistryObject<FlowingFluid> stage3,
                /* Item stage4, */ Item stage5, Tier tier) {
            this(oreTag, stage1, stage2, stage3, /* stage4, */ stage5, tier, new int[] { 1 });
        }

        public OreProcessingRecipeData(Item ore, RegistryObject<Item> stage1, RegistryObject<Item> stage2, RegistryObject<FlowingFluid> stage3, /* Item stage4, */ Item stage5,
                Tier tier, int[] extraAmounts) {
