...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        List<OreProcessingRecipeData> grinderOres = Arrays.asList(
            ...
            new OreProcessingRecipeData(Items.COPPER_ORE, Tiers.STONE, ModItems.GROUND_COPPER_ORE_ROUGH.get(), Items.COPPER_INGOT),
        ...
        List<OreProcessingRecipeData> ballMillOres = Arrays.asList(
            ...
            new OreProcessingRecipeData(ModItems.GROUND_COPPER_ORE_ROUGH.get(), Tiers.STONE, ModItems.GROUND_COPPER_ORE_FINE.get(), Items.COPPER_INGOT),
