...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.AMBER_BLOCK.get())
            ...
            .addCriterion("has_amber", hasItem(ModItems.AMBER.get()))
            .build(consumer);

        // 9 Amber = Amber Block
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.AMBER.get(), 9)
            .addIngredient(ModBlocks.AMBER_BLOCK.get())
            .addCriterion("has_amber_block", hasItem(ModBlocks.AMBER_BLOCK.get()))
            .build(consumer);
        ...
        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(ModItems.COAGULATED_LATEX.get()), ModItems.RUBBER.get(), 0.1f, 200)
            .addCriterion("has_coagulated_latex", hasItem(ModItems.COAGULATED_LATEX.get()))
            .build(consumer);
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.MOTOR_TIER1.get())
            ...
            .addCriterion("has_motor_tier_0", hasItem(ModItems.MOTOR_TIER0.get()))
            .build(consumer);
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.MOTOR_TIER2.get())
            ...
            .addCriterion("has_motor_tier_1", hasItem(ModItems.MOTOR_TIER1.get()))
            .build(consumer);
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.MOTOR_TIER3.get())
            ...
            .addCriterion("has_motor_tier_2", hasItem(ModItems.MOTOR_TIER2.get()))
            .build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(ModItems.BATTERY.get())
            ...
            .key('n', Items.QUARTZ)
            .key('r', Items.REDSTONE)
            .addCriterion("has_nether_quartz", hasItem(Items.QUARTZ))
            .build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(ModItems.POWER_SOCKET.get())
            ...
            .addCriterion("has_redstone_wire", hasItem(ModItems.REDSTONE_WIRE.get()))
            .build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(ModItems.GRINDER_WHEEL_TIER0.get())
            ...
            .addCriterion("has_coupling", hasItem(ModItems.COUPLING.get()))
            .build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.POWER_CABLE.get(), 3)
            ...
            .key('w', ModItems.REDSTONE_WIRE.get())
            .addCriterion("has_rubber", hasItem(ModItems.RUBBER.get()))
            .build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.SOLAR_PANEL.get())
            ...
            .addCriterion("has_daylight_detector", hasItem(Items.DAYLIGHT_DETECTOR))
            .build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(ModItems.MILLING_BALL_TIER0.get(), 4)
            ...
            .patternLine(" p ")
            .key('p', ItemTags.PLANKS)
            .addCriterion("has_wood_planks", hasItem(ItemTags.PLANKS))
            .build(consumer);
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.MILLING_BALL_TIER1.get())
            ...
            .addCriterion("has_milling_ball_tier0", hasItem(ModItems.MILLING_BALL_TIER0.get()))
            .build(consumer);
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.MILLING_BALL_TIER2.get())
            ...
            .addCriterion("has_milling_ball_tier1", hasItem(ModItems.MILLING_BALL_TIER1.get()))
            .build(consumer);
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.MILLING_BALL_TIER3.get())
            ...
            .addIngredient(Items.DIAMOND)
            .addCriterion("has_milling_ball_tier2", hasItem(ModItems.MILLING_BALL_TIER2.get()))
            .build(consumer);
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.MILLING_BALL_TIER4.get())
            ...
            .addIngredient(Items.NETHERITE_INGOT)
            .addCriterion("has_milling_ball_tier3", hasItem(ModItems.MILLING_BALL_TIER3.get()))
            .build(consumer);
        ...
        grinderOres.stream().forEach(data -> {
            ...
            ManufactoryRecipeBuilder.grinderRecipe(Ingredient.fromItems(data.getInput()), data.getOutput())
                ...
                .addCriterion(String.format("has_%s", inputName), hasItem(data.getInput()))
                .build(consumer);

            // Ground Ore (Rough) -> Ingot
            CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(data.getOutput()), data.getProcessed(), 0.2f, 200)
                .addCriterion(String.format("has_%s", outputName), hasItem(data.getOutput()))
        ...
        ManufactoryRecipeBuilder.grinderRecipe(Ingredient.fromItems(Items.NETHER_GOLD_ORE), ModItems.GROUND_GOLD_ORE_ROUGH.get())
            ...
            .addCriterion("has_nether_gold_ore", hasItem(Items.NETHER_GOLD_ORE))
